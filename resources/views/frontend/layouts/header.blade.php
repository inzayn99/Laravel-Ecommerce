@section('header')
    ...
    <!--[if lt IE 9]>
        ...
        <![endif]-->
        <link rel="{{url('shortcut icon" href="images/ico/favicon.ico')}}">
        <link rel="{{url('apple-touch-icon-precomposed" sizes="144x144" href="images/ico/apple-touch-icon-144-precomposed.png')}}">
        <link rel="{{url('apple-touch-icon-precomposed" sizes="114x114" href="images/ico/apple-touch-icon-114-precomposed.png')}}">
        <link rel="{{url('apple-touch-icon-precomposed" sizes="72x72" href="images/ico/apple-touch-icon-72-precomposed.png')}}">
